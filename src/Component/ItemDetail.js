		...
		<div>
				...
				<div className="row">
					...
					<div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
						...
						<h5 className="my-2">maximum height : <span className="lead">{this.props.location.item.state.height}</span></h5>
						<h5 className="my-2">maintenance : <span className="lead">{this.props.location.item.state.maintain}</span></h5>
						<h5 className="my-2">soil drainage : <span className="lead">{this.props.location.item.state.soil}</span></h5>
						<h5 className="my-2">weather condition : <span className="lead">{this.props.location.item.state.sun}</span></h5>
